...
import { Synergies, SynergyType, Synfilters } from "./domain/synergies";
...
export class SynergyCalculator {
    ...
    synergyOfSquares(squares: Square[]) {
        ...
        const unifiedTypeSynergies = this.#unifyTypeSynergies(typeSynergiesOfSquares, subtypeSynergiesOfSquares);
        ...
        return this.#calculateTotalSynergy(filteredTypeSynergies, filteredRowtypeSynergies, timeDifferences);
    }
     ...
     */
    #unifyTypeSynergies(typeSynergies: CombinedSynergies, subtypeSynergies: CombinedSynergies): CombinedSynergies {
    ...
    #filterForType(type: string, synergies: number[]) {
        ...
        const sortedSynergies = (filter.minmax === 'min') ? sortAscending(synergies) : sortDescending(synergies);
