...
export const exampleBingoList = {
  ...
  normal: {
    ...
    5: [
      {
        ...
        skill: 0,
        subtypes: { czl: 1, hearts3: 0.5, saria: 1.75, skulls: 0.25 },
        time: 4,
        types: {
          incsongs: 100,
          poachers: 3.5,
      ...
      {
        difficulty: 5,
        id: "all-4-adult-skulltulas-in-zora-s-types-area",
        jp: "大人時代のゾーラの里エリアの黄金のスタルチュラ4匹",
        name: "All 4 Adult Skulltulas in Zora's Domain Area",
    ...
    6: [
      ...
      },
      {
        ...
        jp: "ボス部屋の鍵2つ",
        name: "2 Boss Keys",
        rowtypes: { bottle: 0.5, gclw: 1, hookshot: 2, ms: 2 },
        skill: 0,
        subtypes: { compass: 2, hearts3: 1, hearts4: 1, map: 3 },
        time: 4.75,
        types: {
          aganon: 3,
          bganon: -2.75,
      ...
      },
      {
        ...
        rowtypes: { bottle: 100, gclw: 0, hookshot: 100, ms: 3.75 },
        skill: 0.5,
        subtypes: {
          bosskey2: 2,
          hearts3: 3,
    ...
    7: [
      ...
      },
      {
        ...
        rowtypes: { bottle: 1, gclw: 0.5, hookshot: 2, ms: 2 },
        skill: 0.5,
        time: 5,
      ...
      },
      {
        ...
        skill: 0.75,
        subtypes: { bombbag: 100, bosskey: 2.5, hovers: 1, skulls: 0.25 },
        time: 5.5,
        types: {
          aganon: 3,
          bganon: -2.75,
    ...
    8: [
      {
        ...
        jp: "コンパス4つ",
        name: "4 Compasses",
        rowtypes: { bottle: 0, gclw: 0.5, hookshot: 0.5, ms: 0.75 },
        skill: 0,
      ...
      },
      {
        ...
        rowtypes: { bottle: 100, gclw: 0, hookshot: 0, ms: 0 },
        skill: 0.75,
        subtypes: { hearts4: 0.25, jabu: 2.75, skulls: 2 },
        time: 5.75,
        types: {
          childchu: 0,
          incranchskulls: 100,
    ...
    9: [
      ...
      {
        difficulty: 9,
        id: "all-4-child-skulltulas-in-zora-s-types-area",
    ...
    10: [
      ...
      },
      {
        ...
        jp: "ボス部屋の鍵3つ",
        name: "3 Boss Keys",
        rowtypes: { bottle: 0.5, gclw: 1, hookshot: 100, ms: 100 },
        skill: 0.25,
        subtypes: { compass: 2, hearts3: 2, hearts4: 1, map: 4 },
        time: 7.75,
        types: {
          aganon: 3,
          bganon: -2.75,
    ...
    11: [
      ...
      },
      {
        ...
        rowtypes: { bottle: 0, gclw: 1, hookshot: 0, ms: 3 },
        skill: 0.25,
        subtypes: { compass: 2, hearts3: 4, hearts4: 1, map: 2, skulls: 1.25 },
        time: 8.25,
        types: {
      ...
      },
      {
        ...
        skill: 0.75,
        subtypes: { bombbag: 100, bulletbag: 100, hovers: 1.5, skulls: 0.5 },
        time: 8.5,
        types: {
          aganon: 3,
          bganon: -2.75,
    ...
    12: [
      ...
      },
      {
        ...
        jp: "コンパス5つ",
        name: "5 Compasses",
        rowtypes: { bottle: 0, gclw: 1, hookshot: 0.5, ms: 2 },
        skill: 0.25,
        subtypes: {
          bosskey2: 2,
          ganonchu: -0.5,
      ...
      },
      {
        ...
        rowtypes: { bottle: 0.5, gclw: 1, hookshot: 100, ms: 0 },
        skill: 0,
        subtypes: {
          bosskey: 2,
          bosskey2: 5,
      ...
      },
      {
        ...
        rowtypes: { bottle: 0.5, gclw: 1, hookshot: 0.25, ms: 2.75 },
        skill: 0,
        subtypes: {
          bosskey: 2,
          compass: 4,
    ...
    13: [
      {
        difficulty: 13,
        id: "all-8-zora-s-types-area-skulltulas",
      ...
      },
      {
        ...
        rowtypes: { bottle: 0.5, gclw: 1, hookshot: 100, ms: 5 },
        skill: 0.25,
        subtypes: {
          bosskey: 2,
          compass: 4,
      ...
      },
      {
        ...
        jp: "メガトンハンマー",
        name: "Megaton Hammer",
        rowtypes: { bottle: 0.5, gclw: 1, hookshot: 0.25, ms: 2.5 },
        skill: 0.25,
        subtypes: {
          bosskey: 2,
          compass: 4,
      ...
      },
      {
        ...
        rowtypes: { bottle: 0, gclw: 0, hookshot: 100, ms: 6 },
        skill: 0.5,
      ...
      },
      {
        ...
        jp: "ミラーシールド",
        name: "Mirror Shield",
        rowtypes: { bottle: 0, gclw: 0, hookshot: 100, ms: 2.25 },
        skill: 0.75,
        subtypes: {
          bosskey: 3,
          bosskey2: 5,
      ...
      },
      {
        ...
        rowtypes: { bottle: 0.5, gclw: 0, hookshot: 100, ms: 1.5 },
        skill: 0.75,
        subtypes: {
          bombbag: 100,
          bosskey: 3,
    ...
    14: [
      ...
      },
      {
        ...
        jp: "盾3種",
        name: "3 Shields",
        rowtypes: { bottle: 0, gclw: 0, hookshot: 100, ms: 2.5 },
        skill: 0.75,
        subtypes: {
          bosskey: 3,
          bosskey2: 5,
      ...
      },
      {
        ...
        jp: "フロルの風",
        name: "Farore's Wind",
        rowtypes: { bottle: 0, gclw: 1, hookshot: 0.5, ms: 2.25 },
        skill: 0,
        subtypes: {
          aganon: 0.25,
          botw: -1,
    ...
    15: [
      ...
      },
      {
        ...
        rowtypes: { bottle: 0.5, gclw: 1, hookshot: 0.25, ms: 3.25 },
        skill: 0.25,
        subtypes: {
          bosskey: 2,
          compass: 4,
    ...
    16: [
      ...
      },
      {
        ...
        rowtypes: { bottle: 100, gclw: 1, hookshot: 0.25, ms: 4.25 },
        skill: 0.25,
        subtypes: {
          aganon: 1,
          bosskey: 2,
      ...
      },
      {
        ...
        rowtypes: { bottle: 0, gclw: 1, hookshot: 100, ms: 11 },
        skill: 0.5,
        subtypes: {
          bosskey: 2,
          compass: 2,
    ...
    17: [
      ...
      },
      {
        ...
        rowtypes: { bottle: 0, gclw: 1, hookshot: 1, ms: 9 },
        skill: 0.75,
      ...
      },
      {
        ...
        rowtypes: { bottle: 0, gclw: 1, hookshot: 100, ms: 7.75 },
        skill: 0.25,
        subtypes: {
          bossdoor: 1.5,
          bosskey: 3.5,
    ...
    18: [
      ...
      },
      {
        ...
        jp: "炎のメダル",
        name: "Fire Medallion",
        rowtypes: { bottle: 0.5, gclw: 1, hookshot: 0.5, ms: 4.75 },
        skill: 0.25,
        subtypes: {
          aganon: 2.5,
          bosskey: 2,
      ...
      },
      {
        ...
        rowtypes: { bottle: 0.5, gclw: 1, hookshot: 0.5, ms: 3 },
        skill: 0.25,
        subtypes: {
          bosskey: 2.25,
          compass: 4,
      ...
      },
      {
        ...
        rowtypes: { bottle: 100, gclw: 1, hookshot: 100, ms: 11.25 },
        skill: 0.25,
        subtypes: {
          aganon: 0.25,
          bossdoor: 1.5,
    ...
    19: [
      ...
      },
      {
        ...
        jp: "マップ7つ",
        name: "7 Maps",
        rowtypes: { bottle: 0.5, gclw: 1, hookshot: 1, ms: 4 },
        skill: 0.5,
        subtypes: {
          bosskey2: 2,
          claimcheck: 6,
    ...
    20: [
      {
        ...
        rowtypes: { bottle: 0.5, gclw: 1, hookshot: 100, ms: 5.5 },
        skill: 0.75,
        subtypes: {
          bosskey: 3,
          bosskey2: 5,
    ...
    21: [
      {
        ...
        rowtypes: { bottle: 0.5, gclw: 1, hookshot: 100, ms: 10 },
        skill: 0.75,
        subtypes: {
          bosskey: 4,
          bosskey2: 3,
    ...
    22: [
      {
        ...
        rowtypes: { bottle: 100, gclw: 1, hookshot: 100, ms: 6 },
        skill: 1,
    ...
    23: [
      ...
      },
      {
        ...
        rowtypes: { bottle: 0, gclw: 1, hookshot: 1, ms: 100 },
        skill: 1,
        subtypes: { skulls: 1 },
        time: 17,
    ...
    24: [
      {
        ...
        rowtypes: { bottle: 0.5, gclw: 1, hookshot: 100, ms: 12 },
        skill: 1,
        subtypes: {
          bosskey: 4,
          bosskey2: 3,
  ...
  short: {
    ...
    12: [
      ...
      {
        difficulty: 12,
        id: "all-4-child-zora-s-types-area-skulltulas",
        jp: "ゾーラの里エリアの黄金のスタルチュラ8匹",
